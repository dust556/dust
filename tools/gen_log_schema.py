...
DESC = {
 ...
 "f_h4_direction": ("0/1", "H4 direction gate passed"),
 "f_h4_slope": ("0/1", "H4 EMA50 slope point"),
 "f_h4_adx": ("0/1", "H4 ADX/DI point"),
 "f_m15_pullback": ("0/1", "M15 pullback point"),
 "f_m15_structure": ("0/1", "M15 structure point"),
 "f_m5_breakout": ("0/1", "M5 breakout hard gate passed"),
 "f_m5_candle": ("0/1", "M5 candle quality point"),
 "f_m5_momentum": ("0/1", "M5 momentum point"),
 "f_vol_point": ("0/1", "VolRatio inside [0.80,1.80]"),
 "f_spread_point": ("0/1", "SpreadRatio <= 0.12"),
 "f_vol_block": ("0/1", "VolRatio > 2.50, new entries forbidden"),
 "f_spread_block": ("0/1", "SpreadRatio > 0.20, new entries forbidden"),
 ...
 "stops_level": ("points", "SYMBOL_TRADE_STOPS_LEVEL at the decision_tick"),
 ...
 "order_calc_profit_1lot": ("account ccy", "OrderCalcProfit entry->SL for 1.00 lot (signed loss)"),
 ...
 "slippage_points": ("points", "positive = filled worse than requested"),
 ...
 "mfe_r_3bars": ("R", "MFE within the first 3 M5 bars"),
 "mae_r_3bars": ("R", "MAE within the first 3 M5 bars"),
 "mfe_r_6bars": ("R", "MFE within the first 6 M5 bars"),
 "mae_r_6bars": ("R", "MAE within the first 6 M5 bars"),
 ...
 "state_store_status": ("enum", "STORE_OK / STORE_FILE_ONLY / STORE_GV_ONLY / STORE_MISMATCH_CONSERVATIVE / STORE_BOTH_LOST / STORE_FRESH"),
